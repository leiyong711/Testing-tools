...
# 按钮文本配置
devicesb = tkinter.Button(root, text='查询设备号', bg='#B8B8B8', font=('', 11), command=devices)  # 性能测试‘开始按钮’
...
# 文字控件布局
canvas.create_window(80, 40, window=sblabel)  # 设备号文字布局
canvas.create_window(400, 105, window=xn)  # 性能测试文字布局
canvas.create_window(130, 220, window=cpulabel)  # 性能测试‘cpu’文字布局
canvas.create_window(635, 220, window=liullabel)  # 性能测试‘流量’文字布局
canvas.create_window(830, 165, window=cs_label)  # 性能测试‘参数次数’文字布局
canvas.create_window(365, 220, window=ramlabel)  # 性能测试‘内存’文字布局
...
# 输出文本布局
canvas.create_window(230, 40, window=devices_win)  # 性能测试‘设备号’输出文本布局
canvas.create_window(130, 165, window=cpu_win)  # 性能测试‘cpu’输出文本布局
canvas.create_window(635, 165, window=liul_win)  # 性能测试‘流量’输出文本布局
canvas.create_window(365, 165, window=ram_win)  # 性能测试‘内存’输出文本布局
canvas.create_window(230, 440, window=qds_win)  # 启动测试‘启动时间展示’输出文本布局
